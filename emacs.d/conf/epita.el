...
(setq header-made-by    "Made by "
      ...
      header-for        " for "
      header-in         " in "
      domaine-name      "gmail.com")
(if (setq user-nickname "John Doe")
    t
  (setq user-nickname "John Doe")
)
...
(setq std-c-alist               '( (cs . "/*") (cc . "** ") (ce . "*/") )
      ...
      std-caml-alist            '( (cs . "(*") (cc . "** ") (ce . "*)") )
      std-sci-alist             '( (cs . "//") (cc . "// ") (ce . "//") )
